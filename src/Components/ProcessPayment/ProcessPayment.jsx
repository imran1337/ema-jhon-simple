    ...
    !paymentMethod && (
      <form className="Form" onSubmit={HandleSubmit}>
        ...
        {error && (
          <Alert
            variant="danger"
            className="text-center mx-3 mb-0 ErrorMessage"
          >
            {error.message}
          </Alert>
        )}
...
const stripePromise = loadStripe(
  "pk_test_51IeBlMIWXEjNRXa90cUgGzr6l5ePByR8T9SDvaVy424k6eWLHYCvLB4TtjhvXN9jeLu3WIeWRXSclXRqrpxHe6U700u9Ii3ZQj"
);
